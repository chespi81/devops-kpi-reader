 ...
 */
@ApiModel(description = "A paginated list of branch restriction rules.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-07-04T23:42:53.141-04:00")
public class PaginatedPullrequest   {
  @JsonProperty("next")
  private String next = null;

  @JsonProperty("values")
  private List<Pullrequest> values = new ArrayList<Pullrequest>();
  ...
  public PaginatedPullrequest next(String next) {
    this.next = next;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequest values(List<Pullrequest> values) {
    this.values = values;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequest pagelen(Integer pagelen) {
  ...
  **/
  ...
  public PaginatedPullrequest size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequest page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public PaginatedPullrequest previous(String previous) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaginatedPullrequest paginatedBranchrestrictions = (PaginatedPullrequest) o;
  ...
  public String toString() {
    ...
    sb.append("class PaginatedPullRequest {\n");
