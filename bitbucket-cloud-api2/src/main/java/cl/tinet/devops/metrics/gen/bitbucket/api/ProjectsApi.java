...
public class ProjectsApi {
  ...
  public void setApiClient(ApiClient apiClient) {
	 ...
	 * 
	 * @param owner
	 *            The team which owns the project. This can either be the
	 *            &#x60;username&#x60; of the team or the &#x60;UUID&#x60; of
	 *            the team (surrounded by curly-braces (&#x60;{}&#x60;)).
	 *            (required)
	 * @return PaginatedProjects
	 * @throws ApiException
	 *             if fails to make API call
	 */
	public PaginatedProjects teamsOwnerProjectsGet(String owner)
			throws ApiException {
		return teamsOwnerProjectsGet(owner, 1);
	}
	 ...
	 *             if fails to make API call
	 */
	public PaginatedProjects teamsOwnerProjectsGet(String owner, int page)
			throws ApiException {
		...
		if (owner == null) {
			throw new ApiException(400,
					"Missing the required parameter 'owner' when calling teamsOwnerProjectsGet");
		}

		// create path and map variables
		String localVarPath = "/teams/{owner}/projects/".replaceAll(
				"\\{format\\}", "json").replaceAll("\\{" + "owner" + "\\}",
				apiClient.escapeString(owner.toString()));

		// query params
		List<Pair> localVarQueryParams = new ArrayList<Pair>();
		localVarQueryParams.add(new Pair("page", String.valueOf(page)));
